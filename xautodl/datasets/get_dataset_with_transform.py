...
def get_datasets(name, root, cutout):
    ...
    if name == "cifar10":
        ...
        assert (
            len(train_data) == 1285564 and len(test_data) == 50000  # 1281167
...
def get_nas_search_loaders(
    ...
    if dataset == "cifar10":
        ...
        search_loader = torch.utils.data.DataLoader(
            search_data,  # 25k train + 25k random selected val(maybe repetitive)
            batch_size=batch,
            shuffle=True,
            num_workers=workers,
            pin_memory=True,
        ...
        valid_loader = torch.utils.data.DataLoader(
            ...
            sampler=torch.utils.data.sampler.SubsetRandomSampler(valid_split),  # 25k val
            num_workers=workers,
            pin_memory=True,
        )

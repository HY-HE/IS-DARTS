...
__all__ = ["OPS", "RAW_OP_CLASSES", "ResNetBasicblock", "SearchSpaceNames", "Identity", "FactorizedReduce"]
...
OPS = {
    ...
    "max_pool_3x3": lambda C_in, C_out, stride, affine, track_running_stats:
    POOLING(C_in, C_out, stride, "max", affine, track_running_stats),
    "nor_conv_7x7": lambda C_in, C_out, stride, affine, track_running_stats:
    ReLUConvBN(C_in, C_out, (7, 7), (stride, stride), (3, 3), (1, 1), affine, track_running_stats),
    "nor_conv_3x3": lambda C_in, C_out, stride, affine, track_running_stats:
    ReLUConvBN(C_in, C_out, (3, 3), (stride, stride), (1, 1), (1, 1), affine, track_running_stats),
    "nor_conv_1x1": lambda C_in, C_out, stride, affine, track_running_stats:
    ReLUConvBN(C_in, C_out, (1, 1), (stride, stride), (0, 0), (1, 1), affine, track_running_stats),
    "dua_sepc_3x3": lambda C_in, C_out, stride, affine, track_running_stats:
    DualSepConv(C_in, C_out, (3, 3), (stride, stride), (1, 1), (1, 1), affine, track_running_stats),
    "dua_sepc_5x5": lambda C_in, C_out, stride, affine, track_running_stats:
    DualSepConv(C_in, C_out, (5, 5), (stride, stride), (2, 2), (1, 1), affine, track_running_stats),
    "dil_sepc_3x3": lambda C_in, C_out, stride, affine, track_running_stats:
    SepConv(C_in, C_out, (3, 3), (stride, stride), (2, 2), (2, 2), affine, track_running_stats),
    "dil_sepc_5x5": lambda C_in, C_out, stride, affine, track_running_stats:
    SepConv(C_in, C_out, (5, 5), (stride, stride), (4, 4), (2, 2), affine, track_running_stats),
    "skip_connect": lambda C_in, C_out, stride, affine, track_running_stats: Identity()
    if stride == 1 and C_in == C_out
    else FactorizedReduce(C_in, C_out, stride, affine, track_running_stats),
    "noise": lambda C_in, C_out, stride, affine, track_running_stats: Noise(C_in, C_out, stride),
}
...
RDARTS_SPACE2 = ["dua_sepc_3x3", "skip_connect"]
RDARTS_SPACE3 = ["dua_sepc_3x3", "none", "skip_connect"]
RDARTS_SPACE4 = ["dua_sepc_3x3", "noise"]
...
SearchSpaceNames = {
    ...
    "darts": DARTS_SPACE,
    "rdarts2": RDARTS_SPACE2,
    "rdarts3": RDARTS_SPACE3,
    "rdarts4": RDARTS_SPACE4,
}
...
class Noise(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.stride == 2:
            shape[2] //= 2
            shape[3] //= 2
        return torch.randn(shape, dtype=x.dtype, device=x.device)
